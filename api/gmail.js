...
export default async function handler(req, res) {
  ...
  try {
    ...
    // Gmail supporte jusqu'à 500 résultats par page.
    // Pour Vercel Hobby et l'IA, on limite à 200 emails par analyse.
    // Pour un gros compte, il faut lancer plusieurs analyses par période.
    const maxEmails = clampNumber(req.body?.maxEmails, 1, 200, 100);
